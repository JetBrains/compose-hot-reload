...
kotlin {
    ...
    sourceSets.commonMain.dependencies {
        implementation("org.jetbrains.compose.hot-reload:hot-reload-core:1.1.0-alpha02")
        implementation("org.jetbrains.compose.hot-reload:hot-reload-analysis:1.1.0-alpha02")
