...
kotlin {
    ...
    sourceSets.commonMain.dependencies {
        implementation("org.jetbrains.compose.hot-reload:hot-reload-core:1.2.0-alpha.mcp+200")
        implementation("org.jetbrains.compose.hot-reload:hot-reload-analysis:1.2.0-alpha.mcp+200")
