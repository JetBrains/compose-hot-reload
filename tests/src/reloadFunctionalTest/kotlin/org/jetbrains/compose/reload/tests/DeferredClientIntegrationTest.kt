...
import org.jetbrains.compose.reload.orchestration.startOrchestrationAwaitingClient
...
class DeferredClientIntegrationTest {
    @HotReloadTest
    @QuickTest
    fun `test - connection`(fixture: HotReloadTestFixture) = fixture.runTest {
        ...
        fixture.launchTestDaemon {
            ...
            runner.buildFlow(
                ":hotRunJvm", "--mainClass", "MainKt", deferred.toJvmArg()
        ...
        client.send(OrchestrationMessage.ShutdownRequest("Requested by test"))
